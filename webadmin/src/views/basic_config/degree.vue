  ...
  <div class="app-container">
    ...
    <el-form size="mini" inline >
      <el-row>
        <el-form-item>
          ...
          <el-form-item >
            <el-input type="text" placeholder="职称" clearable v-model="serverQuerey.name" class="wd16"></el-input>
        </el-form-item>
        <el-form-item >
    ...
    <div>
      ...
      >
        ...
        <el-table-column align="center" prop="name" label="职称"></el-table-column>
          ...
          <el-row :gutter="30">
            ...
            <el-col :span="24">
              <el-form-item label="职称" prop="name">
                <el-input placeholder="请输入职称" style="width: 250px;" v-model="ruleForm.name"></el-input>
              </el-form-item>
            </el-col>
