  ...
  <div class="app-container">
    ...
    <el-form size="mini" inline >
      <el-row>
        <el-form-item>
          ...
          <el-form-item >
            <el-input type="text" placeholder="难度等级" clearable v-model="serverQuerey.name" class="wd16"></el-input>
        </el-form-item>
        <el-form-item >
    ...
    <div>
      ...
      >
        ...
        <el-table-column align="center" prop="name" label="难度等级"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="150">
          <template slot-scope="scope">
            <PermissionLink size="mini" label="编辑" perms="1002" icon="el-icon-edit" type="primary" @click="getById(scope.row.basicConfigId)"/>
            <el-divider direction="vertical"></el-divider>
            <PermissionLink size="mini" label="删除" perms="1003" icon="el-icon-delete" type="danger" @click="delById(scope.row.basicConfigId)"/>
          </template>
        </el-table-column>
      </el-table>
      ...
      <div class="div_center">
        <el-form :model="ruleForm" :rules="rules" size="mini" ref="ruleForm" label-width="90px">
          <el-row :gutter="30">
            ...
            <el-col :span="24">
              <el-form-item label="难度等级" prop="name">
                <el-input placeholder="请输入难度等级" style="width: 250px;" v-model="ruleForm.name"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span="24">
              <el-form-item label="code" prop="code">
                <el-input placeholder="请输入code" style="width: 250px;" v-model="ruleForm.code"></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    async getById(basicConfigId) {
      ...
      const url="/BasicConfig/detail"
      const res = await sendPostByKeyValue(url,{ id: basicConfigId})
      if (res) {
        ...
        beforeClose: async (action, instance, done) => {
          ...
          if (action === "confirm") {
            ...
            for (let i = 0; i < this.multipleSelection.length; i++) {
              ids.push(this.multipleSelection[i].basicConfigId);
            }
            // 删除操作
            const url = "/BasicConfig/deletes";
