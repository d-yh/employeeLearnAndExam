<template>
  <div class="app-container">
    <el-form :inline="true" size="mini">
      ...
      <el-form-item>
        <el-select v-model="serverQuerey.country" @keyup.enter.native="search" clearable filterable placeholder="请选择国家">
            <el-option v-for="item in optionsCountry" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-form-item >
      ...
      <el-form-item>
        <el-input v-model="keyword" @keyup.enter.native="search" clearable placeholder="搜索关键词"></el-input>
      </el-form-item>
      <el-form-item >
      ...
      >
       ...
       <el-table-column align="center" prop="workNumber" label="工号"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="90">
          <template slot-scope="scope">
            <PermissionLink size="mini" label="移除" perms="1013" type="info" @click="removeBlacklist(scope.row.userId)"/>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
          ...
          <el-row :gutter="30">
            ...
            <el-col :span="12">
              <el-form-item label="籍贯" prop="nativePlace">
                <el-input placeholder="请输入籍贯" class="w250" v-model="ruleForm.nativePlace"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="户口性质" prop="householdRegister">
                <el-input placeholder="请输入户口性质" class="w250" v-model="ruleForm.householdRegister"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="户口所在地" prop="residence">
                <el-input placeholder="请输入户口所在地" style="width: 646px;" v-model="ruleForm.residence"></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    removeBlacklist(userId) {
      this.$confirm("确定移除黑名单?", "提示", {
        ...
        beforeClose: (action, instance, done) => {
          ...
          if (action === "confirm") {
            // 删除操作
            sendGet("/user/removeBlacklist?userId=" + userId)
              .then((response) => {
                if (response.code == 200) {
                    this.search();
                  this.$message({
    ...
    async add() {
      ...
      if(this.ruleForm.professionEcho){
