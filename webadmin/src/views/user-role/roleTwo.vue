<template>
  <div class="app-container">
          ...
          >
            ...
            <el-table-column label="操作" align="center" width="140">
              <template slot-scope="{row}">
                <el-link type="primary" size="mini" icon="el-icon-edit" @click="editOne(row.trainingId)">编辑
                </el-link>
                <el-divider direction="vertical"></el-divider>
                <el-link type="danger" size="mini" icon="el-icon-delete" @click="deleteOne(row.trainingId)">删除
                </el-link>
    ...
    >
      ...
      <el-form :model="addDormitoryModel" :rules="dormitoryModelRules" label-position="right" ref="addDormitoryModelRef" label-width="100px" size="mini" class="form">
        ...
        <el-row :gutter="43">
          ...
          <el-row>
            <el-form-item label="章节:" >
              <el-button type="primary" @click="createRow" size="mini" style=" margin-bottom: 10px">添加章节</el-button>
              <el-table
                class="optionTable"
          ...
          <el-col :span="12">
              <el-form-item label="防作弊时间:" prop="intervalTime">
                <el-input placeholder="请输入防作弊时间" class="w250" v-model="addDormitoryModel.intervalTime">
  ...
  export default {
    ...
    beforeAvatarUpload(file) {
     ...
     async dormitorySave() {
      ...
      this.addDormitoryModel.professionId = this.currentData.id == -1 ? this.currentData.id : this.currentData.id.slice(2);
      }
